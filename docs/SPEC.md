...
8. **Gestione stagionale** (B.32–B.36, Fase 15): indisponibilità sopravvenute, rilevazione utilizzi, escalation giustificazione→diffida→decadenza (soglie 🔧), effetti su CAA stagione successiva. **Prossimo blocco da pianificare.**
